    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-main" role="tabpanel"
              aria-labelledby="pills-profile-tab" ref="mainArea">
              <div class="mb-3">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div class="row gx-0 align-items-center">
                    <template v-if="!isAdding">
                      ...
                      <div class="col-auto">
                        <button class="set-category text-secondary" @click="setCategory">
                    ...
                    <template v-else>
                      ...
                      <div class="col-auto d-flex">
                        <button class="set-category text-secondary" @click="addCategory">
                          <i class="fas fa-check"></i>
                        </button>
                        <button class="set-category text-muted" @click="isAdding = false">
            ...
            <div class="tab-pane fade" id="pills-img" role="tabpanel"
             aria-labelledby="pills-home-tab">
              ...
              <div class="row">
                <div class="col-7">
                  ...
                  <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button class="btn btn-sm btn-secondary disabled" v-else>
              ...
              <div class="row align-items-center" v-if="product.imagesUrl.length !== 6">
                ...
                <button class="col-5 mx-auto btn btn-outline-danger" @click="addImages">
                  確定上傳
                </button>
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-sm btn-primary" @click="trigger">
            確認
          </button>
        </div>
      </div>
